...
local THEME = {
	...
	AccentBlue = Color3.fromRGB(0, 116, 189),
	AccentBluePressed = Color3.fromRGB(0, 90, 145),
...
local WalletBalanceLabel -- se duoc gan gia tri khi CheckoutPanel duoc tao ben duoi
...
local function RefreshWalletDisplay()
	...
	if WalletBalanceLabel then
		WalletBalanceLabel.Text = formatCurrency(LocalWalletBalance)
	end
end
...
-- Cum hien thi so du vi, nam ben trai nut Close
local WalletBadge = Instance.new("Frame", CheckoutPanel)
WalletBadge.AnchorPoint = Vector2.new(1, 0.5)
WalletBadge.Position = UDim2.new(1, -50, 0, 28)
WalletBadge.Size = UDim2.new(0, 0, 0, 20)
WalletBadge.AutomaticSize = Enum.AutomaticSize.X
WalletBadge.BackgroundTransparency = 1

local WalletLayout = Instance.new("UIListLayout", WalletBadge)
...
WalletLayout.Padding = UDim.new(0, 6)

local WalletIcon = Instance.new("ImageLabel", WalletBadge)
WalletIcon.Size = UDim2.new(0, 20, 0, 20)
WalletIcon.Image = UI_ASSETS.CurrencyToken
WalletIcon.BackgroundTransparency = 1
WalletIcon.LayoutOrder = 1

WalletBalanceLabel = Instance.new("TextLabel", WalletBadge)
WalletBalanceLabel.Size = UDim2.new(0, 0, 0, 20)
WalletBalanceLabel.AutomaticSize = Enum.AutomaticSize.X
WalletBalanceLabel.BackgroundTransparency = 1
WalletBalanceLabel.Text = "0"
WalletBalanceLabel.TextColor3 = THEME.TextWhite
WalletBalanceLabel.Font = Enum.Font.GothamMedium
WalletBalanceLabel.TextSize = 14
WalletBalanceLabel.LayoutOrder = 2
...
Instance.new("UICorner", ProductPreview).CornerRadius = UDim.new(1, 0)
...
ProductTitleLabel.Font = Enum.Font.GothamBold
...
Instance.new("UICorner", SubmitButtonFrame).CornerRadius = UDim.new(0, 8)
...
SuccessMessageLabel.Text = "Giao dịch mua hàng đã hoàn tất"
...
Instance.new("UICorner", OkButtonFrame).CornerRadius = UDim.new(0, 8)
